...
static Key keys[] = {
    ...
    STACKKEYS(MODKEY, focus) STACKKEYS(MODKEY | ShiftMask, move){
        MODKEY, XK_p, spawn, {.v = dmenucmd}},
    {MODKEY, XK_Return, spawn, {.v = termcmd}},
    {MODKEY, XK_d, spawn, {.v = dmenucmd}},
    {MODKEY | ShiftMask, XK_Escape, spawn,
     SHCMD("prompt \"Leave Xorg?\" \"pkill Xorg\"")},
    {MODKEY, XK_b, togglebar, {0}},
    {MODKEY | ShiftMask, XK_x, spawn,
     SHCMD("prompt \"Shutdown computer?\" \"sudo -A shutdown -h now\"")},
    {MODKEY, XK_minus, spawn,
     SHCMD("amixer sset Master 5%- ; pkill -RTMIN+10 dwmblocks")},
    {0, XF86XK_AudioMute, spawn,
     SHCMD("amixer sset Master toggle ; pkill -RTMIN+10 dwmblocks")},
    ...
    {MODKEY | ShiftMask, XK_BackSpace, spawn,
     SHCMD("prompt \"Reboot computer?\" \"sudo -A reboot\"")},
